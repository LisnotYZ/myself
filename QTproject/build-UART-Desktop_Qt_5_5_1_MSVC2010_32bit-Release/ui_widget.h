...
public:
    ...
    void setupUi(QWidget *Widget)
    {
        ...
        HexReceiveBox = new QCheckBox(Widget);
        ...
        timesendBox = new QCheckBox(Widget);
        ...
        cycleEdit = new QLineEdit(Widget);
        ...
        receiveLabel = new QLabel(Widget);
        ...
        reductionButton = new QPushButton(Widget);
        ...
        stpButton = new QPushButton(Widget);
